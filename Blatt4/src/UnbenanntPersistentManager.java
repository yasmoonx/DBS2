...
public class UnbenanntPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Unbenannt";
	...
	private UnbenanntPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new UnbenanntPersistentManager();
		}
